    ...
    it 'runs collectstatic' do
      app.deploy do |app|
        expect(clean_output(app.output)).to match(Regexp.new(<<~REGEX))
          ...
          remote:        \\['/tmp/build_\\w+',
          remote:         '/invalid-path',
          remote:         '/app/.heroku/python/lib/python310.zip',
          remote:         '/app/.heroku/python/lib/python3.10',
          remote:         '/app/.heroku/python/lib/python3.10/lib-dynload',
          remote:         '/app/.heroku/python/lib/python3.10/site-packages'\\]
          remote:        
