...
- Use `EPOCHREALTIME` (Bash 5.0+) with microsecond precision for buildpack data store timing logic ([#1881](https://github.com/heroku/heroku-buildpack-python/pull/1881))
