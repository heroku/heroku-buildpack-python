...
- Ensured Python runtimes are built with Tk support by default by exporting `PYTHON_CONFIGURE_OPTS=--with-tcltk` and installing the Tcl/Tk build dependencies. ([#XXXX](https://github.com/heroku/heroku-buildpack-python/pull/XXXX))
