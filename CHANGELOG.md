...
- Updated uv from 0.7.3 to 0.7.5. ([#1800](https://github.com/heroku/heroku-buildpack-python/pull/1800))
...
[unreleased]: https://github.com/heroku/heroku-buildpack-python/compare/v286...main
