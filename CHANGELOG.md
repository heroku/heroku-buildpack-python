...
- Updated Poetry from 2.4.1 to 2.4.2. ([#2139](https://github.com/heroku/heroku-buildpack-python/pull/2139))
- Updated uv from 0.12.5 to 0.12.9. ([#2139](https://github.com/heroku/heroku-buildpack-python/pull/2139))
